...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1L, "user1","user1","user1", "user1", "ROLE_USER");
    protected static final User USER_2 = new User(2L, "user2","user2","user2", "user2", "ROLE_USER");
    private static final User USER_3 = new User(3L, "user3","user3", "user3", "user3", "ROLE_USER");
    ...
    public void create_user_creates_a_user() {
        User newUser = new User(-1L, "new", "first name", "lastname", "user", "ROLE_USER");

        boolean userWasCreated = sut.create(newUser.getUsername(), newUser.getFirstName(), newUser.getLastName(), newUser.getPassword(), "ROLE_USER");
